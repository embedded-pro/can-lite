...
namespace services
{
    ...
    public:
        ...
        static bool WriteInt16(hal::Can::Message& msg, std::size_t offset, int16_t value);
        static int16_t ReadInt16(const hal::Can::Message& msg, std::size_t offset);
        static bool WriteInt32(hal::Can::Message& msg, std::size_t offset, int32_t value);
        static int32_t ReadInt32(const hal::Can::Message& msg, std::size_t offset);

        static bool WriteUInt16(hal::Can::Message& msg, std::size_t offset, uint16_t value);
        static uint16_t ReadUInt16(const hal::Can::Message& msg, std::size_t offset);
        static bool WriteUInt32(hal::Can::Message& msg, std::size_t offset, uint32_t value);
